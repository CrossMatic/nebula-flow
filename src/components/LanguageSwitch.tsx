...
export function LanguageSwitch({ variant = "floating", compact = false }: LanguageSwitchProps) {
  ...
  const wrapperClass =
    variant === "inline"
      ? "rounded-lg border border-white/10 bg-[#02040a]/90 p-1"
      : "fixed right-4 top-4 z-[70] rounded-xl border border-white/15 bg-[#02040a]/95 p-1 shadow-[0_0_16px_rgba(59,130,246,0.18)]";
