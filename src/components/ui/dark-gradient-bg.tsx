...
const NOISE_SVG =
  ...
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="150" height="150"><filter id="n"><feTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="2" stitchTiles="stitch"/></filter><rect width="100%" height="100%" filter="url(%23n)"/></svg>`
  );
...
export function DarkGradientBg({ className }: DarkGradientBgProps) {
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(rgb(59, 130, 246) 0%, rgba(59, 130, 246, 0) 100%)",
      ...
      {/* Noise texture (locally generated, no external host) */}
      <div
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at center, rgba(30, 41, 59, 0.2), transparent 70%)",
        }}
      />
    </div>
  );
