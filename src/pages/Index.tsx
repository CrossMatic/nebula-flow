...
const Index = () => {
  ...
  const t = isDe
    ? {
        ...
        heroSub: "Im Einsatz bei Farner Consulting und weiteren führenden Agenturen und Beratungen.",
    ...
    : {
        ...
        heroSub: "In use at Farner Consulting and other leading agencies and consultancies.",
